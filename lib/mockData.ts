export interface Driver { id: number; name: string; avatar: string; rating: number; plate: string; vehicle: string; eta: number; }
export interface Vehicle { id: number; type: string; icon: string; seats: string; price: number; tag: string; }
export interface Route { label: string; distance: string; duration: string; }
